...
session_start();
?>
<form id="editluggagestoragecost" method="POST">
...
<div class="row justify-content-center mt-3">
        <div class="form-group">
            <input type="text"  id="new-cost" placeholder="New Cost" pattern="[0-9]{1,}" required>
        </div>
    </div>
</div>
    ...
    <div class="row justify-content-center mt-3">
        <div class="form-group">
            <input type="text" id="cost-per-hour" placeholder="Cost Per Hour" pattern="[0-9]{1,}" required>
        </div>
    </div>
<div class="row justify-content-center mt-3">
    <div class="form-group">
        <input type="text" id="min-cost" placeholder="Minimun Cost" pattern="[0-9]{1,}" required>
    </div>
</div>
</div>
